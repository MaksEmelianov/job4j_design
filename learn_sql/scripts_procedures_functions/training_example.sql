...
alter procedure f_update_data(u_count integer, tax float, u_id integer) rename to update;
drop procedure f_update_data(u_count integer, tax float, u_id integer);
delete from products;
ALTER SEQUENCE products_id_seq RESTART WITH 1;