...
public class RoleStoreTest {
    ...
    @Test
    void whenAddAndFindThenNameRoleIsAdmin() {
        RoleStore store = new RoleStore();
        store.add(new Role("1", "Admin"));
        Role result = store.findById("1");
        assertThat(result.getNameRole()).isEqualTo("Admin");
    }
    ...
    @Test
    void whenAddDuplicateAndFindNameRoleIsAdmin() {
        RoleStore store = new RoleStore();
        store.add(new Role("1", "Admin"));
        store.add(new Role("1", "User"));
        Role result = store.findById("1");
    ...
    @Test
    void whenReplaceThenNameRoleIsUser() {
        RoleStore store = new RoleStore();
        store.add(new Role("1", "Admin"));
        store.replace("1", new Role("1", "User"));
        Role result = store.findById("1");
        assertThat(result.getNameRole()).isEqualTo("User");
    }
    ...
    @Test
    void whenNoDeleteRoleThenNameRoleIsPetr() {
        RoleStore store = new RoleStore();
        store.add(new Role("1", "Admin"));
        store.delete("10");
        Role result = store.findById("1");
